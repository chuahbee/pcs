						...
						<div className="col-xl-4 col-md-4 col-sm-6">
							<div className="icon-bx-wraper left m-b10">
								...
								<div className="icon-content">
									<p>+60 12 621 9269<br/>info@portestudio.xyz</p>
								</div>
							</div>
						</div>
						<div className="col-xl-4 col-md-4 col-sm-6">
				...
				<div className="row">
					<div className="col-xl-3 col-lg-4 col-sm-6 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        <div className="widget widget_about">
							...
							<p>We are a new and small Art studio do a Art & Design</p>
					...
					<div className="col-xl-3 col-lg-2 col-sm-6 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
						<div className="widget widget_services">
							...
							<ul>
								...
								<li><Link href="/coming-soon"><a>About Us</a></Link></li>
					...
					<div className="col-xl-3 col-lg-3 col-sm-6 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
						<div className="widget widget_services">
							...
							<ul>
								<li><Link href="/coming-soon"><a>Signboard / Printing</a></Link></li>
								<li><Link href="/coming-soon"><a>Design / Illustrator</a></Link></li>
							</ul>
						</div>
                    </div>
					<div className="col-xl-3 col-lg-3 col-sm-6 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.8s">
						<div className="widget widget_services">
						   ...
						   <ul>
								...
								<li><Link href="/coming-soon"><a>Portfolio</a></Link></li>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12 text-center"> 
						<span className="copyright-text">Copyright © {new Date().getFullYear()} PCS. All rights reserved.</span> 
					</div>
                </div>
            </div>
        </div>
